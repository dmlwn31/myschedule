...
<head>
  ...
  <style>
    ...
    .authForm input{width:200px; height:35px; border:1px solid pink; outline:0; padding:5px; display:block; float:left; margin-right:5px;}
    .authForm button{width:100px; height:35px; border:1px solid pink; background:pink; color:#fff; text-align:center;display:block;float:right;}
  </style>
</head>
<body>
  <div class="authWrap">
