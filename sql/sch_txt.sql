...
(3, 'dbProject', '게시판 업로드 수정', '1. 게시판 업로드 수정 완료<br /><br />\r\n2. 페이징 처리 작업 예정', '2021-02-10'),
...
(9, 'webProject', '구현 전 PPT 파일 목차 정리', '1. 구현 전 목차 정리 및 표준화 작업<br /><br /><br />\r\n2. 구현 언어 선정', '2021-02-01'),
(10, 'webProject', '발표 자료 준비', '1. 목차별 발표 자료 준비', '2021-02-02'),
(11, 'webProject', '기획 마무리', '디자인 작업 중', '2021-02-15'),
(12, 'dbProject', '추가일정1', '추가일정1', '2021-02-16'),
(13, 'dbProject', '추가일정50', '추가일정2', '2021-02-16');
...
--
ALTER TABLE `sch_txt`
  MODIFY `sch_txt_num` int(11) NOT NULL AUTO_INCREMENT COMMENT '고유번호', AUTO_INCREMENT=15;
COMMIT;
